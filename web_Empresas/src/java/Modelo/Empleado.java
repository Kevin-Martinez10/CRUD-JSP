...
public class Empleado extends Persona{
    ...
    public DefaultTableModel leer (){
        ...
        try {
            cn = new Conexion();
            cn.abrir_connexion();
            String query = "SELECT e.id_empleados as id,e.codigo,e.nombres,e.apellidos,e.direccion,e.telefono,e.fecha_nacimiento,p.puesto FROM empleados as e inner join puestos as p on e.id_puesto = e.id_puesto;";
