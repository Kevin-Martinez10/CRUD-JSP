<%-- 
    Document   : index
    Created on : 26/09/2021, 02:24:47 PM
      ...
      <div class="modal-content">
        <div class="modal-body">
             <form action="sr_empleados" method="post" class="form-group">
               <label for="lbl_id_cliente" ><b>ID_Cliente</b></label>
                ...
                <input type="number" name="txt_telefono" id="txt_telefono" class="form-control" placeholder="Ejemplo: 00000" required>
